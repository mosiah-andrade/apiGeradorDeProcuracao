...
export default function CalculadoraSolarPro() {
  ...
  return (
    <div className=" bg-white text-slate-900" style={{width: "90vw", maxWidth: "500px"}}>
      <header className="mb-8 border-b pb-4">
        <h1 className="text-3xl font-bold text-blue-900">Colculadora Solar Pro</h1>
      ...
      {calculo && (
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6" >
          ...
          {/* Coluna do Gráfico */}
          <div className="xl:col-span-3 bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
            <h3 className="font-bold text-slate-700 mb-6 uppercase text-sm">Geração Mensal Esperada (kWh)</h3>
            <div style={{  height: '350px', width: "90vw", maxWidth: "600px", margin: "0 auto", backgroundColor: "#011b36", padding: "10px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              {isMounted && (
